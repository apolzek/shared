...
require (
	github.com/myuser/my-otel-collector/processors/logscore v0.1.0
...
replace github.com/myuser/my-otel-collector/processors/logscore v0.1.0 => /home/apolzek/Workdir/github.com/apolzek/shared/drafts/draft-07/processors/logscore
